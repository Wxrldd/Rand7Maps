export const data = [
  {
    ...
    boardView: require('../assets/map1.jpg'),
    boardIcon: require('../assets/iconmap1.png'),
  },
  {
    id: '2',
    name: "Circuit Débridé",
    description: "Un circuit rapide et sinueux, idéal pour les courses effrénées.",
    boardView: require('../assets/map2.jpg'),
    boardIcon: require('../assets/iconmap2.png'),
  },
  {
    id: '3',
    name: "Île Goomba",
    description: "Une île pleine de Goombas et d'obstacles, un vrai défi pour les aventuriers.",
    boardView: require('../assets/map3.jpg'),
    boardIcon: require('../assets/iconmap3.png'),
  },
  {
    id: '4',
  ...
  },
  {
    ...
    boardView: require('../assets/map5.jpg'),
    boardIcon: require('../assets/iconmap5.png'),
  },
  {
    id: '6',
